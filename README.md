...
### Folksonomie
Procédé d'affinement et de structuration de bases de données basé sur un pilotage assez souple, piloté par la communauté, utilisé dans certains projets de bases de données collaboratives comme OpenStreetMap
